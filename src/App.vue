...
<template>
  <div id="app" :class="{ darkApp : isDarkTheme }">
    <!-- Header -->
    <div class="header pt-2 pb-2" :class="{ darkHeader : isDarkTheme }">
      <div class="container d-flex align-items-center justify-content-between">
        <router-link to="/"><h1 class="text-decoration-none">¿Donde en el mundo?</h1></router-link>
        <a @click="isDarkTheme = !isDarkTheme" class="btn d-flex align-items-center justify-content-between">
          <div><i class="far fa-moon mr-1"></i></div>
          <p class="m-0">Modo Oscuro</p></a>
      </div>
    </div>
